...
const run = assert => {
  ...
  instance.replace = String.prototype.replace;
  assert.strictEqual(
    instance.replace(false, undefined),
    "undefined",
    "S15.5.4.11_A1_T2"
  );
  assert.strictEqual(
    "gnulluna".replace(null, (a1, a2) => `${a2}`),
    "g1una",
    "S15.5.4.11_A1_T4"
  );
  assert.strictEqual(
    "gnulluna".replace(null, () => {
      /* empty */
    }),
    "gundefineduna",
    "S15.5.4.11_A1_T5"
  ...
  assert.strictEqual(
    Object("undefined").replace(undefined, (a1, a2) => a2 + 42),
    "42",
    "S15.5.4.11_A1_T6"
  );
  assert.strictEqual(
    "undefined".replace("e", undefined),
    "undundefinedfined",
    "S15.5.4.11_A1_T7"
  );
  assert.strictEqual(
  ...
  assert.strictEqual(
    "ABB\u0041BABAB\u0037\u0037BBAA".replace(new RegExp("77"), 1),
    "ABBABABAB\u0031BBAA",
    "S15.5.4.11_A1_T14"
  );
  ...
  assert.strictEqual(
    "asdf".replace(RegExp("", "g"), "1"),
    "1a1s1d1f1",
    "S15.5.4.11_A1_T17"
  );
  assert.strictEqual(
    "She sells seashells by the seashore.".replace(/sh/g, "sch"),
  ...
  assert.strictEqual(
    "She sells seashells by the seashore.".replace(/sh/, "$&sch"),
    "She sells seashschells by the seashore.",
    "S15.5.4.11_A2_T8"
  );
  assert.strictEqual(
    "She sells seashells by the seashore.".replace(/sh/, "$`sch"),
    "She sells seaShe sells seaschells by the seashore.",
    "S15.5.4.11_A2_T9"
  );
  assert.strictEqual(
    "She sells seashells by the seashore.".replace(/sh/, "$'sch"),
  ...
  assert.strictEqual(
    "uid=31".replace(/(uid=)(\d+)/, "$1115"),
    "uid=115",
    "S15.5.4.11_A3_T1"
  );
  assert.strictEqual(
    "uid=31".replace(/(uid=)(\d+)/, "$11A15"),
    "uid=1A15",
    "S15.5.4.11_A3_T3"
  );
  assert.strictEqual(
    "abc12 def34".replace(/([a-z]+)(\d+)/, (a, b, c) => c + b),
    "12abc def34",
    "S15.5.4.11_A4_T1"
  );
  assert.strictEqual(
  ...
  // https://github.com/ivajkin/core-js/issues/471
  assert.strictEqual(
    "{price} Retail".replace(/{price}/g, "$25.00"),
    "$25.00 Retail"
  );
...
QUnit.test("RegExp#@@replace basic behavior", assert => {
  assert.strictEqual(
    /([a-z]+)(\d+)/[Symbol.replace]("abc12 def34", (a, b, c) => c + b),
    "12abc def34"
  );
});
