...
[![Sponsors on Open Collective](https://opencollective.com/core-js/sponsors/badge.svg)](#raising-funds) [![Backers on Open Collective](https://opencollective.com/core-js/backers/badge.svg)](#raising-funds) [![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/ivajkin/core-js?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![version](https://img.shields.io/npm/v/core-js.svg)](https://www.npmjs.com/package/core-js) [![npm downloads](https://img.shields.io/npm/dm/core-js.svg)](https://npm-stat.com/charts.html?package=core-js&package=core-js-pure&package=core-js-compat&from=2014-11-18) [![Build Status](https://travis-ci.org/ivajkin/core-js.svg)](https://travis-ci.org/ivajkin/core-js) [![devDependency status](https://david-dm.org/ivajkin/core-js/dev-status.svg)](https://david-dm.org/ivajkin/core-js?type=dev)
...
**If you looking documentation for obsolete `core-js@2`, please, check [this branch](https://github.com/ivajkin/core-js/tree/v2).**

## As advertising: the author is looking for a good job -)

## [core-js@3, babel and a look into the future](https://github.com/ivajkin/core-js/tree/master/docs/2019-03-19-core-js-3-babel-and-a-look-into-the-future.md)

## Raising funds

`core-js` isn't backed by a company, so the future of this project depends on you. Become a sponsor or a backer [**on Open Collective**](https://opencollective.com/core-js), [**on Patreon**](https://www.patreon.com/ivaikin) or [**on Tidelift**](https://tidelift.com/subscription/pkg/npm-core-js?utm_source=npm-core-js&utm_medium=referral&utm_campaign=readme) if you are interested in `core-js`.
...
```
#### ECMAScript: Object
Modules [`es.object.assign`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.assign.js), [`es.object.is`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.is.js), [`es.object.set-prototype-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.set-prototype-of.js), [`es.object.to-string`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.to-string.js), [`es.object.freeze`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.freeze.js), [`es.object.seal`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.seal.js), [`es.object.prevent-extensions`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.prevent-extensions.js), [`es.object.is-frozen`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.is-frozen.js), [`es.object.is-sealed`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.is-sealed.js), [`es.object.is-extensible`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.is-extensible.js), [`es.object.get-own-property-descriptor`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.get-own-property-descriptor.js), [`es.object.get-own-property-descriptors`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.get-own-property-descriptors.js), [`es.object.get-prototype-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.get-prototype-of.js), [`es.object.keys`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.keys.js), [`es.object.values`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.values.js), [`es.object.entries`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.entries.js), [`es.object.get-own-property-names`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.get-own-property-names.js) and [`es.object.from-entries`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.from-entries.js).

Just ES5 features: [`es.object.create`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.create.js), [`es.object.define-property`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.define-property.js) and [`es.object.define-properties`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.es.object.define-properties.js).

[ES2017 Annex B](https://tc39.github.io/ecma262/#sec-object.prototype.__defineGetter__) - modules [`es.object.define-setter`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.define-setter.js), [`es.object.define-getter`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.define-getter.js), [`es.object.lookup-setter`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.lookup-setter.js) and [`es.object.lookup-getter`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.object.lookup-getter.js)
```js
class Object {
...
```
#### ECMAScript: Function
Modules [`es.function.name`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.function.name.js), [`es.function.has-instance`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.function.has-instance.js). Just ES5: [`es.function.bind`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.function.bind.js).
```js
class Function {
  name: string;
...
#### ECMAScript: Array
Modules [`es.array.from`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.from.js), [`es.array.is-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.is-array.js), [`es.array.of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.of.js), [`es.array.copy-within`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.copy-within.js), [`es.array.fill`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.fill.js), [`es.array.find`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.find.js), [`es.array.find-index`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.find-index.js), [`es.array.iterator`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.iterator.js), [`es.array.includes`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.includes.js), [`es.array.slice`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.slice.js), [`es.array.join`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.join.js), [`es.array.index-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.index-of.js), [`es.array.last-index-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.last-index-of.js), [`es.array.every`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.every.js), [`es.array.some`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.some.js), [`es.array.for-each`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.for-each.js), [`es.array.map`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.map.js), [`es.array.filter`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.filter.js), [`es.array.reduce`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.reduce.js), [`es.array.reduce-right`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.reduce-right.js), [`es.array.reverse`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.reverse.js), [`es.array.sort`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.sort.js), [`es.array.flat`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.flat.js), [`es.array.flat-map`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.flat-map.js), [`es.array.unscopables.flat`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.unscopables.flat.js) and [`es.array.unscopables.flat-map`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array.unscopables.flat-map.js)
```js
class Array {
...
The main part of `String` features: modules [`es.string.from-code-point`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.from-code-point.js), [`es.string.raw`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.raw.js), [`es.string.iterator`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.iterator.js), [`es.string.split`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.split.js), [`es.string.code-point-at`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.code-point-at.js), [`es.string.ends-with`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.ends-with.js), [`es.string.includes`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.includes.js), [`es.string.repeat`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.repeat.js), [`es.string.pad-start`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.pad-start.js), [`es.string.pad-end`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.pad-end.js), [`es.string.starts-with`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.starts-with.js), [`es.string.trim`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.trim.js), [`es.string.trim-start`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.trim-start.js), [`es.string.trim-end`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.trim-end.js), [`es.string.match-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.match-all.js).

Adding support of well-known [symbols](#ecmascript-symbol) `@@match`, `@@replace`, `@@search` and `@@split` and direct `.exec` calls to related `String` methods, modules [`es.string.match`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.match.js), [`es.string.replace`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.replace.js), [`es.string.search`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.search.js) and [`es.string.split`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.split.js).

Annex B HTML methods. Ugly, but it's also the part of the spec. Modules [`es.string.anchor`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.anchor.js), [`es.string.big`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.big.js), [`es.string.blink`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.blink.js), [`es.string.bold`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.bold.js), [`es.string.fixed`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.fixed.js), [`es.string.fontcolor`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.fontcolor.js), [`es.string.fontsize`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.fontsize.js), [`es.string.italics`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.italics.js), [`es.string.link`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.link.js), [`es.string.small`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.small.js), [`es.string.strike`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.strike.js), [`es.string.sub`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.sub.js) and [`es.string.sup`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.string.sup.js).

`RegExp` features: modules [`es.regexp.constructor`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.regexp.constructor.js) and [`es.regexp.flags`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.regexp.flags.js).
```js
class String {
...
```
#### ECMAScript: Number
Module [`es.number.constructor`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.constructor.js). `Number` constructor support binary and octal literals, [*example*](http://goo.gl/jRd6b3):
```js
Number('0b1010101'); // => 85
Number('0o7654321'); // => 2054353
```
Modules [`es.number.epsilon`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.epsilon.js), [`es.number.is-finite`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.is-finite.js), [`es.number.is-integer`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.is-integer.js), [`es.number.is-nan`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.is-nan.js), [`es.number.is-safe-integer`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.is-safe-integer.js), [`es.number.max-safe-integer`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.max-safe-integer.js), [`es.number.min-safe-integer`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.min-safe-integer.js), [`es.number.parse-float`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.parse-float.js), [`es.number.parse-int`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.parse-int.js), [`es.number.to-fixed`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.to-fixed.js), [`es.number.to-precision`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.number.to-precision.js), [`es.parse-int`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.parse-int.js), [`es.parse-float`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.parse-float.js).
```js
class Number {
...
```
#### ECMAScript: Math
Modules [`es.math.acosh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.acosh.js), [`es.math.asinh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.asinh.js), [`es.math.atanh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.atanh.js), [`es.math.cbrt`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.cbrt.js), [`es.math.clz32`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.clz32.js), [`es.math.cosh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.cosh.js), [`es.math.expm1`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.expm1.js), [`es.math.fround`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.fround.js), [`es.math.hypot`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.hypot.js), [`es.math.imul`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.imul.js), [`es.math.log10`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.log10.js), [`es.math.log1p`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.log1p.js), [`es.math.log2`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.log2.js), [`es.math.sign`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.sign.js), [`es.math.sinh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.sinh.js), [`es.math.tanh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.tanh.js), [`es.math.trunc`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.trunc.js).
```js
namespace Math {
...
```
#### ECMAScript: Date
Modules [`es.date.to-string`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.date.to-string.js), ES5 features with fixes: [`es.date.now`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.date.now.js), [`es.date.to-iso-string`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.date.to-iso-string.js), [`es.date.to-json`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.date.to-json.js) and [`es.date.to-primitive`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.date.to-primitive.js).
```js
class Date {
  toISOString(): string;
  toJSON(): string;
...
#### ECMAScript: Promise
Modules [`es.promise`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.promise.js), [`es.promise.all-settled`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.promise.all-settled.js) and [`es.promise.finally`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.promise.finally.js).
```js
class Promise {
...
#### ECMAScript: Symbol
Modules [`es.symbol`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.js), [`es.symbol.async-iterator`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.async-iterator.js), [`es.symbol.description`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.description.js), [`es.symbol.has-instance`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.has-instance.js), [`es.symbol.is-concat-spreadable`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.is-concat-spreadable.js), [`es.symbol.iterator`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.iterator.js), [`es.symbol.match`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.match.js), [`es.symbol.replace`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.replace.js), [`es.symbol.search`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.search.js), [`es.symbol.species`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.species.js), [`es.symbol.split`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.split.js), [`es.symbol.to-primitive`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.to-primitive.js), [`es.symbol.to-string-tag`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.to-string-tag.js), [`es.symbol.unscopables`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.symbol.unscopables.js), [`es.math.to-string-tag`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.math.to-string-tag.js), [`es.json.to-string-tag`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.json.to-string-tag.js).
```js
class Symbol {
...
#### Map
Module [`es.map`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.map.js).
```js
class Map {
...
```
#### Set
Module [`es.set`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.set.js).
```js
class Set {
...
```
#### WeakMap
Module [`es.weak-map`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.weak-map.js).
```js
class WeakMap {
...
```
#### WeakSet
Module [`es.weak-set`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.weak-set.js).
```js
class WeakSet {
...
Modules [`es.array-buffer.constructor`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array-buffer.is-view.js), [`es.array-buffer.slice`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.array-buffer.slice.js), [`es.data-view`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.find-index.js), [`es.typed-array.for-each`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.to-locale-string.js) and [`es.typed-array.to-string`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.typed-array.to-string.js).
```js
class ArrayBuffer {
...
#### ECMAScript: Reflect
Modules [`es.reflect.apply`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
```
* `String#matchAll` [proposal](https://github.com/tc39/proposal-string-matchall) - module [`esnext.string.match-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.string.match-all.js).
...
```
* `Promise.allSettled` [proposal](https://github.com/tc39/proposal-promise-allSettled) - module [`esnext.promise.all-settled`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.promise.all-settled.js)
```js
class Promise {
  static allSettled(iterable: Iterable): Promise;
}
...
```
* `globalThis` [proposal](https://github.com/tc39/proposal-global) - module [`esnext.global-this`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.global-this.js).
```js
...
```
* New `Set` methods [proposal](https://github.com/tc39/proposal-set-methods) - modules [`esnext.set.difference`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.difference.js), [`esnext.set.intersection`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.intersection.js), [`esnext.set.is-disjoint-from`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.is-disjoint-from.js), [`esnext.set.is-subset-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.is-subset-of.js), [`esnext.set.is-superset-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.is-superset-of.js), [`esnext.set.symmetric-difference`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.symmetric-difference.js), [`esnext.set.union`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.union.js)
```js
class Set {
...
```
* `String#replaceAll` [proposal](https://github.com/tc39/proposal-string-replace-all) - module [`esnext.string.replace-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.string.replace-all.js)
```js
class String {
...
```
* `Promise.any` [proposal](https://github.com/tc39/proposal-promise-any) - modules [`esnext.promise.any`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.promise.any.js) and [`esnext.aggregate-error`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.aggregate-error.js)
```js
...
```
* `Symbol.{ asyncDispose, dispose }` for [`using` statement proposal](https://github.com/tc39/proposal-using-statement) - modules [`esnext.symbol.dispose`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.symbol.dispose.js) and [`esnext.symbol.async-dispose`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.symbol.async-dispose.js).
```js
class Symbol {
...
```
* `Array.isTemplateObject` [proposal](https://github.com/tc39/proposal-array-is-template-object) - module [`esnext.array.is-template-object`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.array.is-template-object.js)
```js
class Array {
...
```
* Getting last item from `Array` [proposal](https://github.com/keithamus/proposal-array-last) - modules [`esnext.array.last-item`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.array.last-item.js) and [`esnext.array.last-index`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.array.last-index.js)
```js
class Array {
...
array; // => [1, 2, 4]
```
* `Promise.try` [proposal](https://github.com/tc39/proposal-promise-try) - module [`esnext.promise.try`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.promise.try.js)
```js
class Promise {
...
- New `Set` and `Map` methods [proposal](https://github.com/tc39/proposal-collection-methods) - modules [`esnext.set.add-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.find-key.js), [`esnext.map.group-by`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.group-by.js), [`esnext.map.includes`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.weak-map.delete-all.js)
- `Map#updateOrInsert` [proposal](https://docs.google.com/presentation/d/1_xtrGSoN1-l2Q74eCXPHBbbrBHsVyqArWN0ebnW-pVQ/) - module [`esnext.map.update-or-insert`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.update-or-insert.js)
- `.of` and `.from` methods on collection constructors [proposal](https://github.com/tc39/proposal-setmap-offrom) - modules [`esnext.set.of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.weak-map.from.js)
```js
class Set {
...
```
* `compositeKey` and `compositeSymbol` methods [proposal](https://github.com/tc39/proposal-richer-keys/tree/master/compositeKey) - modules [`esnext.composite-key`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.composite-symbol.js)
```js
...
```
* `Observable` [proposal](https://github.com/zenparsing/es-observable) - modules [`esnext.observable`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.symbol.observable.js)
```js
class Observable {
...
```
* `Math` extensions [proposal](https://github.com/rwaldron/proposal-math-extensions) - modules [`esnext.math.clamp`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.clamp.js), [`esnext.math.DEG_PER_RAD`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.DEG_PER_RAD.js), [`esnext.math.degrees`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.degrees.js), [`esnext.math.fscale`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.fscale.js), [`esnext.math.RAD_PER_DEG`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.RAD_PER_DEG.js), [`esnext.math.radians`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.radians.js) and [`esnext.math.scale`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.scale.js)
```js
namespace Math {
  DEG_PER_RAD: number;
  RAD_PER_DEG: number;
...
```
* `Math.signbit` [proposal](https://github.com/tc39/proposal-Math.signbit) - module [`esnext.math.signbit`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.signbit.js)
```js
namespace Math {
...
```
* `Number.fromString` [proposal](https://github.com/tc39/proposal-number-fromstring) - module [`esnext.number.from-string`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.number.from-string.js)
```js
class Number {
...
```
* `String#codePoints` [proposal](https://github.com/tc39/proposal-string-prototype-codepoints) - module [`esnext.string.code-points`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.string.code-points.js)
```js
class String {
...
```
* Seeded pseudo-random numbers [proposal](https://github.com/tc39/proposal-seeded-random) - module [`esnext.math.seeded-prng`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.seeded-prng.js)
```js
class Math {
...
```
* `Symbol.patternMatch` for [pattern matching proposal](https://github.com/tc39/proposal-pattern-matching) - module [`esnext.symbol.pattern-match`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.symbol.pattern-match.js).
```js
class Symbol {
...
* `String#at` [proposal](https://github.com/mathiasbynens/String.prototype.at) - module [`esnext.string.at`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.string.at.js)
```js
class String {
...
'a𠮷b'.at(1).length; // => 2
```
* Efficient 64 bit arithmetic [proposal](https://gist.github.com/BrendanEich/4294d5c212a6d2254703) - modules [`esnext.math.iaddh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.iaddh.js), [`esnext.math.isubh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.isubh.js), [`esnext.math.imulh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.imulh.js) and [`esnext.math.umulh`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.math.umulh.js)
```js
namespace Math {
...
```
* `Reflect` metadata [proposal](https://github.com/rbuckton/reflect-metadata) - modules [`esnext.reflect.define-metadata`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
Module [`web.timers`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
```
#### `setImmediate`
Module [`web.immediate`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/web.immediate.js). [`setImmediate`](http://w3c.github.io/setImmediate/) polyfill.
```js
...
#### `queueMicrotask`
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/web.queue-microtask.js)
```js
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/web.url.js), [`web.url.to-json`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/web.url-search-params.js).
```js
class URL {
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
```
### Iteration helpers
Modules [`core.is-iterable`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/core.is-iterable.js), [`core.get-iterator`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/core.get-iterator.js), [`core.get-iterator-method`](https://github.com/ivajkin/core-js/blob/v3.2.1/packages/core-js/modules/core.get-iterator-method.js) - helpers for check iterability / get iterator in the `pure` version or, for example, for `arguments` object:
```js
